<div class="carousel rounded relative z-0 overflow-hidden shadow-xl">
    <div class="carousel-inner relative overflow-hidden w-full">
        ...
        <div class="carousel-item absolute opacity-0 bg-center"
            style="height:400px; background-image: url({{ asset('img/c_restaurante/1.jpg') }});background-repeat:no-repeat;background-size: cover;">
        ...
        <input class="carousel-open hidden" type="radio" id="carousel-r-2" name="carouselrl" aria-hidden="true"
            hidden="">
        <div class="carousel-item absolute opacity-0 bg-center"
            style="height:400px; background-image: url({{ asset('img/c_restaurante/2.jpg') }});background-repeat:no-repeat;background-size: cover;">
        </div>
        ...
        <div class="carousel-item absolute opacity-0"
            style="height:400px; background-image: url({{ asset('img/c_restaurante/3.jpg') }});background-repeat:no-repeat;background-size: cover;">
        </div>
        <label for="carousel-r-2"
