        ...
        <div class="w-80 px-5 py-5 rounded-lg shadow-xl">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div>
                    ...
                    <x-jet-input id="email" class="block mt-2  text-xs w-full" type="email" name="email"
                        :value="old('email')" required autofocus />
                </div>

                <div class="mt-4">
                    <x-jet-label for="password" value="{{ __('Password') }}" />
                    <x-jet-input id="password" class="block mt-2 text-xs w-full" type="password" name="password"
